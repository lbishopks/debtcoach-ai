  ...
  return (
    <AppShell>
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        {error && (
          <div className="bg-red-400/10 border border-red-400/20 rounded-xl p-3 text-red-300 text-sm mb-4">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <select
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-teal-400/50 focus:bg-white/8"
            >
              {categories.map(c => (
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm placeholder-white/30 focus:outline-none focus:border-teal-400/50 focus:bg-white/8"
              required
            />
